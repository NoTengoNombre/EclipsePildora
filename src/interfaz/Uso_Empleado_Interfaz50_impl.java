...
public class Uso_Empleado_Interfaz50_impl {

	public static void main(String[] args) {

		Jefatura50 jefe_RRHH = new Jefatura50("Juan", 55000, 2006, 9, 25);

		jefe_RRHH.establece_Incentivos(2750);

		Empleado50[] misEmpleados = new Empleado50[6];

		misEmpleados[0] = new Empleado50("Ana", 30000, 2000, 07, 07);
		misEmpleados[1] = new Empleado50("Carlos", 50000, 1995, 06, 15);
		misEmpleados[2] = new Empleado50("Paco", 25000, 2005, 9, 25);
		misEmpleados[3] = new Empleado50("Antonio", 47500, 2009, 11, 9);

		misEmpleados[4] = jefe_RRHH; // Polimorfismo : principio de sustitucion

		misEmpleados[5] = new Jefatura50("Maria", 95000, 1999, 5, 26);
		...
		Empleado50 director_comercial = new Jefatura50("Sandra", 85000, 2012, 05, 05);
		...
		// constructor.
		Comparable ejemplo = new Empleado50("Elisabeth", 95000, 2011, 06, 07);
		...
		if (director_comercial instanceof Empleado50) {
...
class Empleado50 implements Comparable { // Ejemplo de como una superclase puede
										// ser implementada por varias
										// Interfaces

	public Empleado50(String nom, double sue, int agno, int mes, int dia) {
		nombre = nom;
		sueldo = sue;
	...
	public int compareTo(Object miObjeto) { // Interfaz
		Empleado50 otroEmpleado = (Empleado50) miObjeto; // con esto tengo una
...
class Jefatura50 extends Empleado50 implements Jefes {

	public Jefatura50(String nom, double sue, int agno, int mes, int dia) {
