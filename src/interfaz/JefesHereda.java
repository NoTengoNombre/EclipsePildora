 ...
 * 
 * @author PORTATIL
 * Jefes Hereda de Trabajadores
 * Jefes Implementa el metodo de esta interfaz y también el metodo de Trabajadores
 */
public interface JefesHereda extends Trabajadores{
	/*
